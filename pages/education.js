...
export default function EducationPage() {
  ...
  return (
    <>
      <SEO path="/education" keywords="aryanjsx, aryan kumar, aryan kumar software engineer, education, certifications, full stack developer" />
      <div className="education-main">
        ...
        <main id="main-content" className="basic-education">
          <Fade direction="down" duration={2000} triggerOnce>
            <div className="education-heading-div">
              ...
              <div className="education-heading-text-div">
                <h1 className="education-heading-text" style={{ color: theme.text }}>Aryan Kumar </h1>
                <h2 className="education-heading-sub-text" style={{ color: theme.text }}>
                  Education — Basic Qualification and Certifications
                </h2>
                <p className="education-header-detail-text subTitle" style={{ color: theme.secondaryText }}>
          ...
          <section className="degrees-section">
            <Fade direction="up" duration={800} triggerOnce>
              <div className="section-header">
                <h3 className="section-title" style={{ color: theme.text }}>Degrees Received</h3>
                  ...
                  <div className="degree-item">
                    ...
                    <div className="degree-card" style={{ backgroundColor: theme.imageDark || "#1a1a2e", border: `1px solid ${theme.text}20`, boxShadow: `0 4px 20px ${theme.text}10` }}>
                      <div className="degree-card-header">
                        <div>
                          <h3 className="degree-institution" style={{ color: theme.text }}>{degree.title}</h3>
                          <p className="degree-type" style={{ color: theme.secondaryText }}>{degree.subtitle}</p>
                        </div>
                        <span className="degree-duration" style={{ backgroundColor: `${theme.accentColor}20`, color: theme.accentColor }}>{degree.duration}</span>
                      </div>
                      <div className="degree-details">
                        {degree.descriptions.map((desc, idx) => <p key={idx} style={{ color: theme.text }}>{desc}</p>)}
                      </div>
                      {degree.website_link && degree.website_link.trim() !== "" && (
                        <a href={degree.website_link} target="_blank" rel="noopener noreferrer" className="degree-link" style={{ backgroundColor: theme.accentColor, color: "#fff" }}>
                          Visit Website →
                        </a>
                      )}
                    </div>
          ...
          <section className="certifications-section">
            <Fade direction="up" duration={800} triggerOnce>
              <div className="section-header">
                <h3 className="section-title" style={{ color: theme.text }}>Certifications</h3>
                <div className="section-line" style={{ backgroundColor: theme.accentColor }} />
              </div>
            </Fade>
            <div className="certifications-grid">
              {certifications.certifications.map((cert, index) => (
                <Fade key={cert.title} direction="up" duration={600} delay={index * 100} triggerOnce>
                  <div className="cert-card" style={{ backgroundColor: theme.imageDark || "#1a1a2e", border: `1px solid ${cert.color_code}40`, boxShadow: `0 4px 15px ${cert.color_code}20` }}>
                    ...
                    <a href={cert.certificate_link} target="_blank" rel="noopener noreferrer" className="cert-card-inner">
                      ...
                      <div className="cert-body">
                        ...
                        <p className="cert-issuer" style={{ color: theme.secondaryText }}>{cert.subtitle}</p>
                      </div>
                    </a>
                  </div>
                </Fade>
